...
class BOVWPipeline:
    ...
    def prepare_set(self, images, classes,x_name,y_name,balance):
    ...
    def pipeline(self):
        ...
        # x_train, y_train = self.prepare_set(train_images, train_classes,"x_train.npy","y_train.npy",True)
        # x_test, y_test = self.prepare_set(test_images, test_classes,"x_test.npy","y_test.npy",False)
        x_train, y_train = self.load_sets("x_train.npy","y_train.npy",True)
